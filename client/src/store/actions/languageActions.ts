...
export function updateLanguageSuccessAction(language: Language): LanguageActions {
    return {
...
export function getLanguagesSuccessAction(languages: Language[]): LanguageActions {
