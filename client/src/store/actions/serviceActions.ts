...
export function updateServiceAction(service: UpdatedService): ServiceActions {
  return {
    type: UPDATE_SERVICE,
    payload: service
  };
...
export function updateServiceSuccessAction(
...
export function addServiceAction(service: NewService): ServiceActions {
  return {
    type: ADD_SERVICE,
    payload: service
  };
