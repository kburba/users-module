import { GET_LANGUAGES, DELETE_LANGUAGE, ADD_LANGUAGE, UPDATE_LANGUAGE } from '../actions/types';
...
import { DeleteLanguageAction, AddLanguageAction, UpdateLanguageAction } from '../types/languageTypes';
import { getLanguagesIsLoadedFromState, getLanguagesFromState } from './selectors';
