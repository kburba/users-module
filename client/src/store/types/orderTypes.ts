...
type Update = UpdateOrderAction | UpdateOrderSuccessAction | UpdateOrderErrorAction;
...
type Delete = DeleteOrderAction | DeleteOrderSuccessAction | DeleteOrderErrorAction;
