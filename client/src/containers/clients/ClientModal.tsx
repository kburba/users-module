...
import { ClientsActions, ClientForm, Client } from '../../store/types/clientTypes';
import { setClientsModal, addClientAction, updateClientAction } from '../../store/actions/clientActions';
...
const mapDispatchToProps = (dispatch: Dispatch<ClientsActions>) => ({
    ...
    updateClient: (updatedClient: Client) => dispatch(updateClientAction(updatedClient)),
});
